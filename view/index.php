                ...
                <tbody id="vista_comercial" class="">
                    ...
                    <tr class="b1">
                        ...
                        <td class="min-content-w f-row jc-c a-c gap5 overflow-auto">
                            <form action="../Request/Comerciales.php" method="post" class="f-row gap5">
                                ...
                                <div type="submit" class="bg-blue p10 br5 pointer mayus"  name="informacion" value="<?= $item->id_comercial ?>">
